...
folder are mapped to the application's root namespace, 'gridDropDown'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'gridDropDown' in the same way
as `"gridDropDown/sass/src"`.
